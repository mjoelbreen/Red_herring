...
function goFish() {
    let query = wordList[Math.floor(Math.random() * wordList.length)];
    return query;
};

let googleWindow;
function googleSearch() {
    googleWindow = window.open("https://www.google.com/search?q=" + goFish());
    await googleWindow.onload;
    googleWindow = window.open("https://www.google.com/search?q=blake");
...
queryButton.onclick = function()  {
    ...
    const facebookSearch = window.open("https://www.facebook.com/search/top?q=" + goFish() + "&epa=SEARCH_BOX");
       
    const amazonSearch = window.open("https://www.amazon.com/s?k=" + goFish() + "&ref=nb_sb_noss");
